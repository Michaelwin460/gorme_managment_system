...
const EditUser = () => {
  ...
  return (
<div className="edit-user-container d-flex justify-content-center align-items-center mt-3">
  <div className="edit-user-form p-3 rounded w-50 border">
    ...
    <form className="row g-1" onSubmit={handleSubmit}>
      ...
      <div className="col-12">
        <label className="form-label">
          <strong>Insert New Password</strong>
        </label>
        <input
          type="text"
          id="inputPassword"
      ...
      {user.status === "leaving" && (
        <div className="col-12">
          ...
          <input
            ...
            onChange={(e) => setUser({ ...user, leave_date: e.target.value })}
          />
        </div>
      )}
